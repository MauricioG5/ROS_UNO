...
def Nodo_F():								#Declarar función "Nodo_F"
	rospy.init_node('Nodo_F', anonymous=False)			#Inicializar el nodo con su nombre asignado
	rospy.Subscriber('String_C', String, callback)			#Se suscribe al Topic "String_B" de tipo String por la función callback
	pub_int = rospy.Publisher('Char_F', Char, queue_size=10);""" Declara qué Topic va a publicar, el tipo de dato a publicar y el tamaño 										del Buffer """
...
if __name__ == '__main__':						#Entrar al main de la función
	try:
		Nodo_F()						#Llamar a la función "Nodo_F"
